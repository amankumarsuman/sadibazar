      ...
      >
        ...
        <nav className={styles["nav"]}>
          ...
          {auth && (
            ...
            >
              Wishlist{" "}
              {user.wishlist?.length > 0 ? `(${user.wishlist?.length})` : ""}
            </Link>
          )}
          {auth && (
            <Link
      ...
      <div className={styles["actions"]}>
        <input
          ...
          className={`${styles["search"]} ${
            search === SEARCH_VISIBLE && styles["search-active"]
          }`}
        />
        <div
        ...
        <Link
          to={"/cart"}
          className={`material-symbols-outlined ${styles["icon"]} ${
            search === SEARCH_VISIBLE && styles["hide-icon"]
          }`}
        >
          shopping_cart
          {cartCount ? (
        ...
        <Link
          onClick={auth && handleDropDown}
          to={!auth && "login"}
          className={`material-symbols-outlined ${styles["account-icon"]} ${styles["icon"]}`}
        >
          person
        </Link>
        {auth && dropdown && (
